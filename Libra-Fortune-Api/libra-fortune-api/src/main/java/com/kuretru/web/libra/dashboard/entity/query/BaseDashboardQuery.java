...
@Data
public abstract class BaseDashboardQuery<T extends Field, M extends Field, D extends Field> {
    ...
    private FilterQuery<M> metricsFilter;

    @Valid
    @Schema(description = "维度过滤条件")
    private FilterQuery<D> dimensionsFilter;
